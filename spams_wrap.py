...
def applyBayerPattern(*args) -> "void":
    """
...
def conjugateGradient(*args) -> "void":
    """
...
def lassoMask(*args) -> "SpMatrix< float > *":
    """
...
def alltrainDL(*args) -> "Matrix< float > **, Matrix< float > **, Vector< int > **":
    """
...
def archetypalAnalysis(*args) -> "SpMatrix< float > **, SpMatrix< float > **":
    """
...
def archetypalAnalysisInit(*args) -> "SpMatrix< float > **, SpMatrix< float > **":
    """
...
def decompSimplex(*args) -> "SpMatrix< float > *":
    """
...
def fistaFlat(*args) -> "Matrix< float > *":
    """
...
def fistaTree(*args) -> "Matrix< float > *":
    """
...
def fistaGraph(*args) -> "Matrix< float > *":
    """
...
def proximalFlat(*args) -> "Vector< float > *":
    """
...
def proximalGraph(*args) -> "Vector< float > *":
    """
...
def treeOfGroupStruct(*args) -> "int *, SpMatrix< bool > **, Vector< int > **, Vector< int > **":
    """
